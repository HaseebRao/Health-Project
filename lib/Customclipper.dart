...
import 'package:health/Pagethirtysix.dart';
class Customclipper extends StatefulWidget {
   Customclipper({super.key});

  @override
  State<Customclipper> createState() => _CustomclipperState();
}

class _CustomclipperState extends State<Customclipper> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        ...
        Padding(
          padding:  EdgeInsets.only(left: width*0.00,top: height*0.01),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Padding(
